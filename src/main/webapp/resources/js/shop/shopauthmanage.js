$(function() {
    var shopId = 1;
    var listUrl = '/o2oproject/shop/listshopauthmapsbyshop?pageIndex=1&pageSize=9999&shopId=' + shopId;
    var deleteUrl = '/o2oproject/shop/removeshopauthmap';
    ...
    $('.shopauth-wrap').on('click', 'a', function (e) {
        ...
        if (target.hasClass('edit')) {
            window.location.href = '/o2oproject/shop/shopauthedit?shopauthId=' + e.currentTarget.dataset.authId;
    ...
    // $('#new').click(function () {
    //     window.location.href = '/o2oproject/shop/shopauthedit';
    // });
});