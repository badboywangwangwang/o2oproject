$(function() {
	...
	shopAuthId = 1;
	var infoUrl = '/o2oproject/shop/getshopauthmapbyid?shopAuthId=' + shopAuthId;

	var shopAuthPostUrl = '/o2oproject/shop/modifyshopauthmap';

	if (shopAuthId) {
		getInfo(shopAuthId);
	} else {
		$.toast('用户不存在！');
		window.location.href = '/o2oproject/shop/shopmanage';
	}
